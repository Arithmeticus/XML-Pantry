...
<xsl:stylesheet xmlns:fn4="http://qt4cg.org/ns"
   ...
   <xsl:template match="property" mode="expand-map">
      ...
      <xsl:variable name="curr-map-key-of-interest"
                    as="xs:string?"
                    select="$curr-map-keys[. = $names]"/>
      ...
      <xsl:apply-templates mode="#current">
         <xsl:with-param name="curr-map-key-of-interest"
                         tunnel="yes"
                         select="$curr-map-key-of-interest"/>
   ...
   <xsl:variable name="fn4:unicode-property-map" as="map(*)">
      <xsl:map>
         <xsl:map-entry use-when="$codepoints-of-interest = 1" key="1">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'START OF HEADING'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 2" key="2">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'START OF TEXT'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 3" key="3">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'END OF TEXT'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 4" key="4">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'END OF TRANSMISSION'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 5" key="5">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'ENQUIRY'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 6" key="6">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'ACKNOWLEDGE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 7" key="7">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'BELL'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 8" key="8">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'BACKSPACE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 9" key="9">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'S'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'lb'" select="'BA'"/>
               <xsl:map-entry key="'na1'" select="'CHARACTER TABULATION'"/>
               <xsl:map-entry key="'Pat_WS'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'SP'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WSpace'" select="true()"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 10" key="10">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'B'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'GCB'" select="'LF'"/>
               <xsl:map-entry key="'lb'" select="'LF'"/>
               <xsl:map-entry key="'na1'" select="'LINE FEED (LF)'"/>
               <xsl:map-entry key="'Pat_WS'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'LF'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'LF'"/>
               <xsl:map-entry key="'WSpace'" select="true()"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 11" key="11">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'S'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'lb'" select="'BK'"/>
               <xsl:map-entry key="'na1'" select="'LINE TABULATION'"/>
               <xsl:map-entry key="'Pat_WS'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'SP'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'NL'"/>
               <xsl:map-entry key="'WSpace'" select="true()"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 12" key="12">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'WS'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'lb'" select="'BK'"/>
               <xsl:map-entry key="'na1'" select="'FORM FEED (FF)'"/>
               <xsl:map-entry key="'Pat_WS'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'SP'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'NL'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 13" key="13">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'B'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'GCB'" select="'CR'"/>
               <xsl:map-entry key="'lb'" select="'CR'"/>
               <xsl:map-entry key="'na1'" select="'CARRIAGE RETURN (CR)'"/>
               <xsl:map-entry key="'Pat_WS'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'CR'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'CR'"/>
               <xsl:map-entry key="'WSpace'" select="true()"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 14" key="14">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'SHIFT OUT'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 15" key="15">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'SHIFT IN'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 16" key="16">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'DATA LINK ESCAPE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 17" key="17">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'DEVICE CONTROL ONE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 18" key="18">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'DEVICE CONTROL TWO'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 19" key="19">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'DEVICE CONTROL THREE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 20" key="20">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'DEVICE CONTROL FOUR'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 21" key="21">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'NEGATIVE ACKNOWLEDGE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 22" key="22">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'SYNCHRONOUS IDLE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 23" key="23">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'END OF TRANSMISSION BLOCK'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 24" key="24">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'CANCEL'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 25" key="25">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'END OF MEDIUM'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 26" key="26">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'SUBSTITUTE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 27" key="27">
            <xsl:map>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'ESCAPE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 28" key="28">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'B'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'INFORMATION SEPARATOR FOUR'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 29" key="29">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'B'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'INFORMATION SEPARATOR THREE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 30" key="30">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'B'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'INFORMATION SEPARATOR TWO'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 31" key="31">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'S'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'na1'" select="'INFORMATION SEPARATOR ONE'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 32" key="32">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'WS'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               ...
               <xsl:map-entry key="'SB'" select="'SP'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'WSegSpace'"/>
               <xsl:map-entry key="'WSpace'" select="true()"/>
            </xsl:map>
         </xsl:map-entry>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 34" key="34">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
               ...
               <xsl:map-entry key="'Pat_Syn'" select="true()"/>
               <xsl:map-entry key="'QMark'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'CL'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'DQ'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 35" key="35">
            <xsl:map>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 36" key="36">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ET'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 37" key="37">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ET'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 38" key="38">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 39" key="39">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               ...
               <xsl:map-entry key="'SB'" select="'CL'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'WB'" select="'SQ'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 40" key="40">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
               <xsl:map-entry key="'bmg'" select="41"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 41" key="41">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
               <xsl:map-entry key="'bmg'" select="40"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 42" key="42">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 43" key="43">
            <xsl:map>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 44" key="44">
            <xsl:map>
               ...
               <xsl:map-entry key="'Pat_Syn'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'SC'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'Term'" select="true()"/>
               <xsl:map-entry key="'WB'" select="'MN'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 45" key="45">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ES'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 46" key="46">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'CS'"/>
               <xsl:map-entry key="'CI'" select="true()"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               ...
               <xsl:map-entry key="'Pat_Syn'" select="true()"/>
               <xsl:map-entry key="'SB'" select="'AT'"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'STerm'" select="true()"/>
               <xsl:map-entry key="'Term'" select="true()"/>
               <xsl:map-entry key="'WB'" select="'MB'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 47" key="47">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'CS'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 48" key="48">
            <xsl:map>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 58" key="58">
            <xsl:map>
               ...
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
               <xsl:map-entry key="'Term'" select="true()"/>
               <xsl:map-entry key="'WB'" select="'ML'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 59" key="59">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 60" key="60">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 61" key="61">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 62" key="62">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 63" key="63">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 64" key="64">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 91" key="91">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
               <xsl:map-entry key="'bmg'" select="93"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 92" key="92">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 93" key="93">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'Bidi_M'" select="true()"/>
               <xsl:map-entry key="'bmg'" select="91"/>
         ...
         <xsl:map-entry use-when="$codepoints-of-interest = 94" key="94">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'CI'" select="true()"/>
               ...
               <xsl:map-entry key="'OMath'" select="true()"/>
               <xsl:map-entry key="'Pat_Syn'" select="true()"/>
               <xsl:map-entry key="'scx'" select="'Zyyy'"/>
            </xsl:map>
         </xsl:map-entry>
         <xsl:map-entry use-when="$codepoints-of-interest = 95" key="95">
            <xsl:map>
               <xsl:map-entry key="'bc'" select="'ON'"/>
               <xsl:map-entry key="'dt'" select="'None'"/>
               <xsl:map-entry key="'ea'" select="'Na'"/>
